...
#define BSP_MAPPED_INT_CFG_B_VECT_S12ADC1_S12GCADI1                       
...
#define BSP_MAPPED_INT_CFG_B_VECT_TSIP_TEST_BUSY                          
#define BSP_MAPPED_INT_CFG_B_VECT_TSIP_WRRDY0                             
#define BSP_MAPPED_INT_CFG_B_VECT_TSIP_WRRDY1                             
#define BSP_MAPPED_INT_CFG_B_VECT_TSIP_WRRDY4                             
#define BSP_MAPPED_INT_CFG_B_VECT_TSIP_RDRDY0                             
#define BSP_MAPPED_INT_CFG_B_VECT_TSIP_RDRDY1                             
#define BSP_MAPPED_INT_CFG_B_VECT_TSIP_INTEGRATE_WRRDY                    
#define BSP_MAPPED_INT_CFG_B_VECT_TSIP_INTEGRATE_RDRDY                    
